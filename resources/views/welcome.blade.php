							...
							<div class="container">
								...
								<div class="card">
									...
									<div class="card-body position-relative">
										<h3 class="7 text-white text-center my-10 my-lg-15"> DFA STATION MOBILE </h3>
										<!-- begin: Tabs-->
											...
											<div class="tab-pane show active row text-center" id="kt-pricing-2_content1" role="tabpanel" aria-labelledby="pills-tab-1">
												<div class="card-body bg-white col-11 col-lg-12 col-xxl-10 mx-auto">
													<div class="row">
														<!-- begin: Pricing-->
														<div class="col-md-4 ">
                                                        <a href="{{route ('station.creer') }}" class="card card-custom bg-info bg-hover-state-danger card-stretch gutter-b">
															<div class="pt-30 pt-md-25 pb-15 px-5 text-center bg-success">
																<!--begin::Icon-->
																...
																<!--end::Icon-->
																<!--begin::Content-->
																<h4 class="font-size-h3 mb-10">Nouvelle Enregistrement</h4>
															...
															<div class="pt-30 pt-md-25 pb-15 px-5 text-center bg-dark">
																...
																<div class="d-flex flex-center position-relative mb-25">
																	...
																	<span class="svg-icon svg-icon-5x svg-icon-primary">
																		...
																		<span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo7\dist/../src/media/svg/icons\Shopping\Sort2.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																			<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																				<rect x="0" y="0" width="24" height="24"/>
														...
														<div class="col-md-4">
                                                        <a href="{{ route ('station.admin') }}" class="card card-custom bg-info bg-hover-state-danger card-stretch gutter-b">
															<div class="pt-30 pt-md-25 pb-15 px-5 text-center bg-danger">
																<!--begin::Icon-->
																<div class="d-flex flex-center position-relative mb-25">
																	<span class="svg svg-fill-primary opacity-4 position-absolute">
																		<svg width="175" height="200">
																	...
																	<span class="svg-icon svg-icon-5x svg-icon-primary">
																		...
																		<span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo7\dist/../src/media/svg/icons\General\Unlock.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																			<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																				<mask fill="white">
