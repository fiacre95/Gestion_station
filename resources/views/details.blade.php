...
<html lang="en">
	...
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" class="print-content-only header-fixed header-mobile-fixed header-bottom-enabled subheader-enabled page-loading">
		<!--begin::Main-->
		<!--begin::Header Mobile-->
								...
								<div class="card card-custom overflow-hidden">
									<div class="card-body p-0">
										...
										<div class="row justify-content-center bgi-size-cover bgi-no-repeat py-8 px-8 py-md-27 px-md-0" style="background-image: url(assets/media/bg/bg-6.jpg);">
											<div class="col-md-9">
												<div class="d-flex justify-content-between pb-10 pb-md-20 flex-column flex-md-row">
													<h1 class="display-4 text-white font-weight-boldest mb-10">FACTURE</h1>
													<div class="d-flex flex-column align-items-md-end px-0">
														<!--begin::Logo-->
														<a href="#" class="mb-5">
															<img src="assets/media/logos/images3.png" alt="" />
														</a>
														<!--end::Logo-->
														<span class="text-white d-flex flex-column align-items-md-end opacity-70">
															<span>Abidjan Bp 76 Niangon</span>
												...
												<div class="d-flex justify-content-between text-white pt-6">
													<div class="d-flex flex-column flex-root">
														...
														<span class="opacity-70">{{ $achat->created_at }}</span>
													</div>
													<div class="d-flex flex-column flex-root">
														<span class="font-weight-bolder mb-2">FACTURE NUMERO  </span>
														<span class="opacity-70">{{ $achat->id }}</span>
													</div>
													<div class="d-flex flex-column flex-root">
														<span class="font-weight-bolder mb-2">DFA STATION</span>
														<span class="opacity-70">Service Cient 
														<br />+225 07 89 30 43 80</span>
													</div>
												</div>
											</div>
										</div>
												...
												<div class="d-flex justify-content-between flex-column flex-md-row font-size-lg">
													<div class="d-flex flex-column mb-10 mb-md-0">
														...
														<div class="d-flex justify-content-between mb-3">
															<span class="mr-15 font-weight-bold">Cathegory :</span>
															<span class="text-right">{{ $achat->cathegory }}</span>
														</div>
														<div class="d-flex justify-content-between mb-3">
															<span class="mr-15 font-weight-bold">Montant:</span>
															<span class="text-right">{{ $achat->montant }}</span>
														</div>
														<div class="d-flex justify-content-between">
															<span class="mr-15 font-weight-bold">Quantite:</span>
															<span class="text-right">{{ $achat->quantite }}</span>
														</div>
													</div>
													<div class="d-flex flex-column text-md-right">
														<span class="font-size-lg font-weight-bolder mb-1">MONTANT TOTAL</span>
														<span class="font-size-h2 font-weight-boldest text-danger mb-1">{{ $achat->quantite * $achat->montant}}</span>
														<span>Taxes Inclus</span>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row justify-content-center py-8 px-8 py-md-10 px-md-0">
											<div class="col-md-9">
												<div class="d-flex justify-content-between">
													<a href="{{ route('station.index')}}"><button type="button" class="btn btn-light-danger font-weight-bold" > Annuler </button></a>
													<button type="button" class="btn btn-primary font-weight-bold" onclick="window.print();">Impression</button>
												</div>
											</div>
										</div>
										<!-- end: Invoice action-->
